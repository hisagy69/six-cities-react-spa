...
const FormComment = (props) => {
  ...
  return <form className="reviews__form form" action="#" method="post" onSubmit={(event) => {
    ...
    }} className="reviews__textarea form__textarea" id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved" ref={commentRef}></textarea>
